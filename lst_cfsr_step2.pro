...
;   Generate transmission, upwelled radiance, and downwelled radiance at each height at each CFSR point
;
; CALL SEQUENCE: lst_cfsr_step2,  home, $            ;directory containing programs and supporting files
...
;                                 alb, $             ;albedo of second MODTRAN run at each height at each CFSR point
;                                 whichLandsat       ;which Landsat sensors this image is captured with
;
;  RESTRICTIONS:
;    Already called lst_cfsr_step1.pro, commandList, and parsed tape6 files
;
